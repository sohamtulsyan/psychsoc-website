          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  layoutId="lamp"
                  className="absolute inset-0 w-full bg-white/[0.05] rounded-full -z-10 shadow-lg shadow-white/10"
                  initial={false}
                  transition={{
                    type: "spring",
                    stiffness: 300,
                ...
                >
                  <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-8 h-1 bg-gradient-to-b from-primary to-primary/50 rounded-t-full">
