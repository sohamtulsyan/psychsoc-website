        ...
        <section className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
            {newsletters.map((newsletter, index) => (
              <GlareCard
                key={index}
                className="flex flex-col p-6 items-start justify-start text-left"
              >
                {/* Cover Image */}
                <div className="w-full relative aspect-square mb-4 overflow-hidden rounded-lg bg-neutral-900 border border-neutral-800">
                  <Image
